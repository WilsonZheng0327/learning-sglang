...
export const chapters: Chapter[] = [
  ...
  { part: 'fast', slug: '12-piecewise-compile', title: 'Piecewise graphs & torch.compile', hook: 'When the graph has to break.', ready: false },
  { part: 'fast', slug: '13-attention-backends', title: 'Attention backends', hook: 'Why there are five kernels for one equation.', ready: false },
  { part: 'fast', slug: '14-speculative-decoding', title: 'Speculative decoding', hook: 'Guess several tokens, verify in one step.', ready: false },
  { part: 'fast', slug: '15-quantization', title: 'Quantization', hook: 'Shrinking the read every step pays for.', ready: false },
  { part: 'fast', slug: '16-two-batch-overlap', title: 'Two-batch overlap', hook: 'Hiding communication behind compute.', ready: false },

  { part: 'scale', slug: '17-tensor-parallel', title: 'Tensor parallelism', hook: 'A model bigger than one GPU.', ready: false },
  { part: 'scale', slug: '18-pipeline-expert-parallel', title: 'Pipeline & expert parallelism', hook: 'Splitting by layer, and by expert.', ready: false },
  { part: 'scale', slug: '19-dp-attention', title: 'Data-parallel attention', hook: 'Replicate the attention side, share the rest.', ready: false },
  { part: 'scale', slug: '20-hierarchical-kv', title: 'Hierarchical KV cache', hook: 'When 64 GB is not enough.', ready: false },
  { part: 'scale', slug: '21-disaggregation', title: 'Prefill-decode disaggregation', hook: 'Two clocks, two machines.', ready: false },
  { part: 'scale', slug: '22-router', title: 'The router', hook: 'Many engines, one front door.', ready: false },

  { part: 'omni', slug: '23-multimodal-inputs', title: 'Multimodal inputs', hook: 'A stage in front of the loop.', ready: false },
  { part: 'omni', slug: '24-multistage-inference', title: 'Multi-stage inference', hook: 'Thinker, talker, and the pipe between them.', ready: false },
  { part: 'omni', slug: '25-streaming-audio', title: 'Streaming audio decode', hook: 'Output with a real-time deadline.', ready: false },
  { part: 'omni', slug: '26-full-duplex', title: 'Full duplex', hook: 'Listening while speaking.', ready: false },
];
